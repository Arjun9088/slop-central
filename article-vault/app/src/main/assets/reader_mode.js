(function() {
    if (window.ArticleVaultReaderMode && window.ArticleVaultReaderMode.version === 1) {
        return;
    }

    var STATE_KEY = "__articleVaultReaderModeState";
    var THEME_KEY = "__articleVaultReaderModeTheme";
    var TRANSITION_KEY = "__articleVaultReaderModeTransition";
    ...
    function readerStyles() {
        ...
        return [
            "<style id=\"articlevault-reader-style\">",
            theme.fontFaceCss,
            "body[data-articlevault-reader='true']{margin:0!important;background:" + theme.backgroundColor + "!important;color:" + theme.textColor + "!important;font-family:" + theme.fontFamily + "!important;line-height:1.68!important;font-size:" + bodyFontSize + "px!important;-webkit-text-size-adjust:100%!important;visibility:visible!important;opacity:1!important;}",
            "#articlevault-reader-mode{box-sizing:border-box;max-width:760px;margin:0 auto;padding:32px 20px 96px!important;background:" + theme.backgroundColor + "!important;color:" + theme.textColor + "!important;visibility:visible!important;opacity:1!important;}",
            "#articlevault-reader-mode *{box-sizing:border-box;max-width:100%;}",
            "#articlevault-reader-kicker{font:600 13px/1.4 -apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif!important;letter-spacing:.04em!important;text-transform:uppercase!important;color:" + theme.linkColor + "!important;margin-bottom:14px!important;}",
            "#articlevault-reader-mode h1{font:700 " + titleFontSize + "px/1.15 " + theme.headingFontFamily + "!important;margin:0 0 12px!important;color:" + theme.headingColor + "!important;}",
            "#articlevault-reader-byline{font:500 " + bylineFontSize + "px/1.5 " + theme.fontFamily + "!important;color:" + theme.secondaryTextColor + "!important;margin:0 0 28px!important;}",
            "#articlevault-reader-article,#articlevault-reader-article section,#articlevault-reader-article div,#articlevault-reader-article figure{background:transparent!important;color:" + theme.textColor + "!important;visibility:visible!important;opacity:1!important;}",
            "#articlevault-reader-article *{background:transparent!important;visibility:visible!important;opacity:1!important;}",
            "#articlevault-reader-article p,#articlevault-reader-article li{font-size:" + bodyFontSize + "px!important;line-height:1.68!important;color:" + theme.textColor + "!important;}",
            "#articlevault-reader-article span,#articlevault-reader-article strong,#articlevault-reader-article em,#articlevault-reader-article small{color:inherit!important;}",
            "#articlevault-reader-article p{margin:0 0 1.05em!important;}",
            "#articlevault-reader-article h2,#articlevault-reader-article h3,#articlevault-reader-article h4,#articlevault-reader-article h5,#articlevault-reader-article h6{font-family:" + theme.headingFontFamily + "!important;line-height:1.25!important;margin:1.65em 0 .6em!important;background:transparent!important;color:" + theme.headingColor + "!important;}",
            "#articlevault-reader-article a{color:" + theme.linkColor + "!important;text-decoration:underline!important;text-decoration-thickness:1px!important;text-underline-offset:3px!important;}",
            "#articlevault-reader-article img,#articlevault-reader-article video{display:block;height:auto!important;margin:1.2em auto!important;border-radius:4px!important;}",
            "#articlevault-reader-article figure{margin:1.4em 0!important;}",
            "#articlevault-reader-article figcaption{font:" + captionFontSize + "px/1.45 " + theme.fontFamily + "!important;color:" + theme.secondaryTextColor + "!important;margin-top:.5em!important;}",
            "#articlevault-reader-article blockquote{border-left:3px solid " + theme.linkColor + "!important;margin:1.3em 0!important;padding:.1em 0 .1em 1em!important;color:" + theme.textColor + "!important;}",
            "#articlevault-reader-article pre{overflow-x:auto!important;background:" + theme.codeBackgroundColor + "!important;color:" + theme.textColor + "!important;border-radius:4px!important;padding:14px!important;font-size:" + codeFontSize + "px!important;line-height:1.5!important;}",
            "#articlevault-reader-article code,#articlevault-reader-article pre *{font-family:ui-monospace,SFMono-Regular,Consolas,'Liberation Mono',monospace!important;font-size:.9em!important;background:transparent!important;color:" + theme.textColor + "!important;}",
            "#articlevault-reader-article table{border-collapse:collapse!important;display:block!important;overflow-x:auto!important;margin:1.2em 0!important;background:transparent!important;color:" + theme.textColor + "!important;}",
            "#articlevault-reader-article thead,#articlevault-reader-article tbody,#articlevault-reader-article tfoot,#articlevault-reader-article tr{background:transparent!important;color:" + theme.textColor + "!important;}",
            "#articlevault-reader-article th,#articlevault-reader-article td{border:1px solid " + theme.dividerColor + "!important;padding:8px!important;background:transparent!important;color:" + theme.textColor + "!important;}",
            "</style>"
        ].join("");
    }
    ...
    function enable() {
        try {
            ...
            var html = [
                readerStyles(),
                "<main id=\"articlevault-reader-mode\">",
                site ? "<div id=\"articlevault-reader-kicker\">" + escapeHtml(site) + "</div>" : "",
                title ? "<h1>" + escapeHtml(title) + "</h1>" : "",
                meta ? "<div id=\"articlevault-reader-byline\">" + escapeHtml(meta) + "</div>" : "",
                "<article id=\"articlevault-reader-article\">",
            ...
            animateOut(document.body, function(transitionId) {
                ...
                restoreAttributes(document.body, {"data-articlevault-reader": "true"});
                document.title = title || originalTitle;
                window.scrollTo(0, 0);
                animateIn(document.getElementById("articlevault-reader-mode") || document.body, transitionId);
            });
            return "enabled";
        } catch (e) {
            return "error";
    ...
    function disable() {
        try {
            ...
            var readerElement = document.getElementById("articlevault-reader-mode") || document.body;
